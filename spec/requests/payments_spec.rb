  ...
  path "/payments" do
    post "Creates a new payment" do
      ...
      response "200", "payment sucessfully created" do
        ...
        # failing.
        # needs better specs for the parameters since the spec understands
        # one thing and the yaml generated by rake rswag does another.
      ...
      response "422", "invalid card date" do
        let(:payment) {
          {
            number: "5555 5555 5555 4445",
            valid: "x",
